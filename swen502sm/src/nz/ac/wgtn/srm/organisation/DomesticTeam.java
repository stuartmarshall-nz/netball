...
public class DomesticTeam extends Team {
	...
	public DomesticTeam(String name, Country location, int yearFormed) {
		super(name, location, yearFormed);
		this.playsIn = null;
	}

	public DomesticTeam(String name, Country location, int yearFormed, Competition competition) {
		super(name, location, yearFormed);
